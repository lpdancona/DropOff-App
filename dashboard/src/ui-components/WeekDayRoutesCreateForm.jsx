...
import { createWeekDayRoutes } from "../graphql/mutations";
export default function WeekDayRoutesCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setVanID(initialValues.vanID);
    setKidID(initialValues.kidID);
    setOrder(initialValues.Order);
    setKidName(initialValues.kidName);
    setKidDropOffAddress(initialValues.kidDropOffAddress);
    setErrors({});
  };
  const validations = {
    date: [],
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await API.graphql({
            query: createWeekDayRoutes.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "WeekDayRoutesCreateForm")}
      {...rest}
    >
      <TextField
        label="Date"
