...
var logger = new Logger('SQLiteDatabase');
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, SQLite.openDatabase({
                                name: DB_NAME,
                                location: 'default',
                            })];
                    case 1:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, SQLite.deleteDatabase({ name: DB_NAME, location: 'default' })];
                    case 2:
                        _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _a = __read.apply(void 0, [_b.sent(), 1]), resultSet = _a[0];
                        result = resultSet &&
                            resultSet.rows &&
                ...
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.db.readTransaction(function (tx) {
                                var e_1, _a;
                                try {
                                    for (var queryParameterizedStatements_1 = __values(queryParameterizedStatements), queryParameterizedStatements_1_1 = queryParameterizedStatements_1.next(); !queryParameterizedStatements_1_1.done; queryParameterizedStatements_1_1 = queryParameterizedStatements_1.next()) {
                                        var _b = __read(queryParameterizedStatements_1_1.value, 2), statement = _b[0], params = _b[1];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.db.transaction(function (tx) {
                            var e_2, _a;
                            try {
                                for (var saveParameterizedStatements_1 = __values(saveParameterizedStatements), saveParameterizedStatements_1_1 = saveParameterizedStatements_1.next(); !saveParameterizedStatements_1_1.done; saveParameterizedStatements_1_1 = saveParameterizedStatements_1.next()) {
                                    var _b = __read(saveParameterizedStatements_1_1.value, 2), statement = _b[0], params = _b[1];
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.db.transaction(function (tx) {
                                var e_3, _a;
                                try {
                                    for (var deleteParameterizedStatements_1 = __values(deleteParameterizedStatements), deleteParameterizedStatements_1_1 = deleteParameterizedStatements_1.next(); !deleteParameterizedStatements_1_1.done; deleteParameterizedStatements_1_1 = deleteParameterizedStatements_1.next()) {
                                        var _b = __read(deleteParameterizedStatements_1_1.value, 2), statement = _b[0], params = _b[1];
                                        tx.executeSql(statement, params);
                                    }
                                }
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        results = [];
                        _a = __read(queryParameterizedStatement, 2), queryStatement = _a[0], queryParams = _a[1];
                        _b = __read(deleteParameterizedStatement, 2), deleteStatement = _b[0], deleteParams = _b[1];
                        return [4 /*yield*/, this.db.transaction(function (tx) {
