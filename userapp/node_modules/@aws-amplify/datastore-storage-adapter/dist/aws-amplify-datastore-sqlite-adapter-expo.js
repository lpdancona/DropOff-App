...
/***/ "./lib-esm/ExpoSQLiteAdapter/ExpoSQLiteDatabase.js":
/*!*********************************************************!*\
  !*** ./lib-esm/ExpoSQLiteAdapter/ExpoSQLiteDatabase.js ***!
  \*********************************************************/
...
/* harmony import */ var expo_file_system__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! expo-file-system */ "expo-file-system");
/* harmony import */ var expo_file_system__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(expo_file_system__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var expo_sqlite__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! expo-sqlite */ "expo-sqlite");
/* harmony import */ var expo_sqlite__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(expo_sqlite__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _common_constants__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../common/constants */ "./lib-esm/common/constants.js");
...
var logger = new _aws_amplify_core__WEBPACK_IMPORTED_MODULE_0__.ConsoleLogger('ExpoSQLiteDatabase');
/*
...
var ExpoSQLiteDatabase = /** @class */function () {
    ...
    return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__awaiter)(this, void 0, void 0, function () {
      return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__generator)(this, function (_a) {
        ...
        if (!this.db) {
          ...
          this.db = (0,expo_sqlite__WEBPACK_IMPORTED_MODULE_2__.openDatabase)(_common_constants__WEBPACK_IMPORTED_MODULE_3__.DB_NAME);
        }
        return [2 /*return*/];
      });
    });
      ...
      return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__generator)(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [4 /*yield*/, (0,expo_file_system__WEBPACK_IMPORTED_MODULE_1__.deleteAsync)(expo_file_system__WEBPACK_IMPORTED_MODULE_1__.documentDirectory + "SQLite/" + _common_constants__WEBPACK_IMPORTED_MODULE_3__.DB_NAME)];
          case 2:
            // delete database is not supported by expo-sqlite.
            // Database file needs to be deleted using deleteAsync from expo-file-system
            _a.sent();
  ...
  ExpoSQLiteDatabase.prototype.batchQuery = function (queryParameterizedStatements) {
    var _this = this;
    if (queryParameterizedStatements === void 0) {
      queryParameterizedStatements = new Set();
    }
        ...
        return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__awaiter)(_this, void 0, void 0, function () {
          ...
          return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__generator)(this, function (_a) {
            switch (_a.label) {
              case 0:
                _a.trys.push([0, 2,, 3]);
                return [4 /*yield*/, Promise.all((0,tslib__WEBPACK_IMPORTED_MODULE_4__.__spread)(queryParameterizedStatements).map(function (_a) {
                  var _b = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__read)(_a, 2),
                    statement = _b[0],
                    params = _b[1];
                  return new Promise(function (resolve, reject) {
                    transaction.executeSql(statement, params, function (_, result) {
  ...
  ExpoSQLiteDatabase.prototype.batchSave = function (saveParameterizedStatements, deleteParameterizedStatements) {
    var _this = this;
    if (saveParameterizedStatements === void 0) {
      saveParameterizedStatements = new Set();
    }
    return new Promise(function (resolveTransaction, rejectTransaction) {
      _this.db.transaction(function (transaction) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__awaiter)(_this, void 0, void 0, function () {
          ...
          return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__generator)(this, function (_a) {
            switch (_a.label) {
              case 0:
                ...
                return [4 /*yield*/, Promise.all((0,tslib__WEBPACK_IMPORTED_MODULE_4__.__spread)(saveParameterizedStatements).map(function (_a) {
                  var _b = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__read)(_a, 2),
                    statement = _b[0],
                    params = _b[1];
                  return new Promise(function (resolve, reject) {
              ...
              case 1:
                ...
                return [4 /*yield*/, Promise.all((0,tslib__WEBPACK_IMPORTED_MODULE_4__.__spread)(deleteParameterizedStatements).map(function (_a) {
                  var _b = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__read)(_a, 2),
                    statement = _b[0],
                    params = _b[1];
                  return new Promise(function (resolve, reject) {
  ...
  ExpoSQLiteDatabase.prototype.selectAndDelete = function (queryParameterizedStatement, deleteParameterizedStatement) {
    var _this = this;
    var _a = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__read)(queryParameterizedStatement, 2),
      queryStatement = _a[0],
      queryParams = _a[1];
    var _b = (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__read)(deleteParameterizedStatement, 2),
      deleteStatement = _b[0],
      deleteParams = _b[1];
    return new Promise(function (resolveTransaction, rejectTransaction) {
      _this.db.transaction(function (transaction) {
        return (0,tslib__WEBPACK_IMPORTED_MODULE_4__.__awaiter)(_this, void 0, void 0, function () {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ExpoSQLiteDatabase);
...
module.exports = __WEBPACK_EXTERNAL_MODULE_expo_file_system__;
...
module.exports = __WEBPACK_EXTERNAL_MODULE_expo_sqlite__;
...
/* harmony import */ var _ExpoSQLiteDatabase__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ExpoSQLiteDatabase */ "./lib-esm/ExpoSQLiteAdapter/ExpoSQLiteDatabase.js");
// Copyright Amazon.com, Inc. or its affiliates. All Rights Reserved.
// SPDX-License-Identifier: Apache-2.0


var ExpoSQLiteAdapter = new _common_CommonSQLiteAdapter__WEBPACK_IMPORTED_MODULE_0__.CommonSQLiteAdapter(new _ExpoSQLiteDatabase__WEBPACK_IMPORTED_MODULE_1__["default"]());
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ExpoSQLiteAdapter);
})();
...
//# sourceMappingURL=aws-amplify-datastore-sqlite-adapter-expo.js.map