...
var logger = new core_1.ConsoleLogger('ExpoSQLiteDatabase');
/*
...
var ExpoSQLiteDatabase = /** @class */ (function () {
            ...
            return tslib_1.__generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, expo_file_system_1.deleteAsync(expo_file_system_1.documentDirectory + "SQLite/" + constants_1.DB_NAME)];
                    case 2:
                        // delete database is not supported by expo-sqlite.
                        // Database file needs to be deleted using deleteAsync from expo-file-system
                        _a.sent();
    ...
    ExpoSQLiteDatabase.prototype.batchQuery = function (queryParameterizedStatements) {
        ...
        return new Promise(function (resolveTransaction, rejectTransaction) {
            _this.db.transaction(function (transaction) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                var results, error_2;
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 2, , 3]);
                            return [4 /*yield*/, Promise.all(tslib_1.__spread(queryParameterizedStatements).map(function (_a) {
                                    var _b = tslib_1.__read(_a, 2), statement = _b[0], params = _b[1];
                                    return new Promise(function (resolve, reject) {
                                        transaction.executeSql(statement, params, function (_, result) {
                ...
                return tslib_1.__generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, Promise.all(tslib_1.__spread(saveParameterizedStatements).map(function (_a) {
                                    var _b = tslib_1.__read(_a, 2), statement = _b[0], params = _b[1];
                                    return new Promise(function (resolve, reject) {
                                        transaction.executeSql(statement, params, function () {
                                            resolve(null);
                        ...
                        case 1:
                            ...
                            return [4 /*yield*/, Promise.all(tslib_1.__spread(deleteParameterizedStatements).map(function (_a) {
                                    var _b = tslib_1.__read(_a, 2), statement = _b[0], params = _b[1];
                                    return new Promise(function (resolve, reject) {
    ...
    ExpoSQLiteDatabase.prototype.selectAndDelete = function (queryParameterizedStatement, deleteParameterizedStatement) {
        var _this = this;
        var _a = tslib_1.__read(queryParameterizedStatement, 2), queryStatement = _a[0], queryParams = _a[1];
        var _b = tslib_1.__read(deleteParameterizedStatement, 2), deleteStatement = _b[0], deleteParams = _b[1];
        return new Promise(function (resolveTransaction, rejectTransaction) {
            _this.db.transaction(function (transaction) { return tslib_1.__awaiter(_this, void 0, void 0, function () {
                var result, error_4;
                return tslib_1.__generator(this, function (_a) {
